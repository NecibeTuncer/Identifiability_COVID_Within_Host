...
% clc
% 
load('Workspace_for_Patient_A_log.mat')
...
[u_predictions,l_predictions,u_prediction_quartiles,l_prediction_quartiles] = plot_results(chain, 5000,data.Y0);
...
%  figure(2); 
  ...
  hold on
  plot(data.l_time,data.sputum,'ko')
  hold on
